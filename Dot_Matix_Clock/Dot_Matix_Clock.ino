...
// Get a label from PROGMEM into a char array
{
  const __FlashStringHelper* const Jan = F("Jan");
   ...
   const __FlashStringHelper* const May = F("Mei");
   const __FlashStringHelper* const Jun = F("Jun");
   const __FlashStringHelper* const Jul = F("Jul");
   const __FlashStringHelper* const Aug = F("Agu");
   const __FlashStringHelper* const Sep = F("Sep");
   const __FlashStringHelper* const Oct = F("Okt");
   const __FlashStringHelper* const Nov = F("Nov");
   const __FlashStringHelper* const Dec = F("Des");
...
{
   const __FlashStringHelper* const Sunday = F("Minggu");
   const __FlashStringHelper* const Monday = F("Senin");
   const __FlashStringHelper* const Tuesday = F("Selasa");
   const __FlashStringHelper* const Wednesday = F("Rabu");
   const __FlashStringHelper* const Thursday = F("Kamis");
   const __FlashStringHelper* const Friday = F("Jumat");
   const __FlashStringHelper* const Saturday = F("Sabtu");
